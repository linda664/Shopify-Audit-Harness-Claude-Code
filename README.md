...
A runtime harness(`CLAUDE.md` and `skills` folder) that turns Claude Code into a Shopify CRO audit agent. Point it at any Shopify URL — it crawls the storefront, reasons over the artifacts, and produces a structured audit report.
